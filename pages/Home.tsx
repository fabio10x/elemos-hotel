    ...
    <div className="min-h-screen">
      ...
      <div className="relative h-screen">
        <div className="absolute inset-0">
          <img
            src="/hero.png"
            alt="Aura Web Service Luxury Exterior"
          ...
          <ScrollReveal>
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
                Located right next to Bole International Airport, Aura Web Service offers a blend of modern comfort and Ethiopian hospitality. Rated 4.5/5 by our guests, we provide a 4-star experience with premium amenities.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <ScrollReveal delay={200} className="space-y-6">
              ...
              <p className="text-gray-400 text-lg leading-relaxed">
                Whether you are traveling for business or leisure, Aura Web Service provides the perfect sanctuary. Our rooms feature select comfort beds, down comforters, and minibars to ensure your stay is relaxing.
              </p>
              <div className="pt-4">
                <div className="text-3xl font-bold text-amber-500">4.5 / 5</div>
                <p className="text-sm text-gray-500">Based on 103 verified reviews</p>
              </div>
            </ScrollReveal>
          </div>
        </div>
